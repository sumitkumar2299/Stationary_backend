...
//                     minLength={5}
//                     placeholder="john"
//                      className="w-full px-3 py-1 mt-2 text-base leading-8 bg-white text-gray-700 transtion-colors duration-200 ease-in-out border-gray-300 rounded outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200">
//                     </input>
